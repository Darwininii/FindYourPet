...
export default function HomePage() {
          ...
          <div className="bg-gray-100 min-h-screen p-6">
            ...
            {mascotas.length === 0 ? (
              <div className="text-center py-10">
                ...
                <p>Aún no se han agregado mascotas perdidas. ¡Sé el primero en reportar!</p>
              </div>
            ) : (
  ...
  return (
    <>
      {/* Navigation Tabs */}
      <div className="flex justify-center space-x-4 p-4 bg-white shadow-sm">
        <button 
          className={`px-4 py-2 rounded ${activeSection === "inicio" ? "bg-blue-500 text-white" : "bg-gray-200"}`}
          onClick={() => setActiveSection("inicio")}
        >
          Inicio
        </button>
        <button 
          className={`px-4 py-2 rounded ${activeSection === "mapa" ? "bg-blue-500 text-white" : "bg-gray-200"}`}
          onClick={() => setActiveSection("mapa")}
        >
          Mapa
        </button>
        <button 
          className={`px-4 py-2 rounded ${activeSection === "reportar" ? "bg-blue-500 text-white" : "bg-gray-200"}`}
