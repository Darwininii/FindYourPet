...
import Boton from "../Componentes/Boton"; // Asegúrate de importar el componente correctamente
...
const Donacion = () => {
  ...
  return (
    <div className={styles.donationContainer}>
      ...
      {/* Usamos el Boton estilizado y le pasamos la lógica de handleDonation */}
      <Boton onClick={handleDonation} />
    </div>
  );
};
